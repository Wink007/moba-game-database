#!/usr/bin/env python3
"""Export medium-long full descriptions (3500-5500 chars) for translation"""
import psycopg2
...
cur.execute("""
    ...
    AND LENGTH(full_description) >= 3500 AND LENGTH(full_description) < 5500
    ORDER BY LENGTH(full_description) ASC
""")
rows = cur.fetchall()

print(f"=== MEDIUM-LONG (3500-5500 chars): {len(rows)} heroes ===\n")
for r in rows:
