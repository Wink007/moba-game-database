...
def add_game(name, description, release_date, genre, background_image=None, video_intro=None, subtitle=None, preview=None, icon=None):
    conn = get_connection()
    cursor = conn.cursor()
    ph = get_placeholder()
    ...
    if DATABASE_TYPE == 'postgres':
        cursor.execute(f"""
            INSERT INTO games (name, description, release_date, genre, background_image, video_intro, subtitle, preview, icon)
            VALUES ({ph}, {ph}, {ph}, {ph}, {ph}, {ph}, {ph}, {ph}, {ph})
            RETURNING id
        """, (name, description, release_date, genre, background_image, video_intro, subtitle, preview, icon))
