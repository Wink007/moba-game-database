                        ...
                        <div className={style['hero-skills']}>
                            ...
                            {maxTransforms > 0 && (
                                <button
                                    ...
                                    className={`${style['transform-button']} ${transformIndex > 0 ? style['transform-button--active'] : ''}`}
                                ...
                                >
                                    ...
                                    {transformIndex > 0 && <span className={style['transform-index']}>{transformIndex}</span>}
                                </button>
                            )}
                        </div>
                        </div>
